...
import {Basvuruogrecisil,basvuruonayla} from '../actions/kayıtlar'
import {connect} from 'react-redux';

class BasvuruVeri extends Component{
            ...
            <div className="extra content">
              <div className="ui two buttons">
                <div className="ui basic green button"
                 onClick={()=>{
                  this.props.basvuruonayla(this.props.veriler)
                }}>Onayla</div>
                <div className="ui basic red button"  
                  onClick={()=>{
                   this.props.Basvuruogrecisil(this.props.veriler.uid)
                 }}>Sil</div>
              </div>
            </div>
          </div>
...
export default  connect(null,{Basvuruogrecisil,basvuruonayla}) (BasvuruVeri);
